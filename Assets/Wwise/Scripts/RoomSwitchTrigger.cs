...
public class RoomSwitchTrigger : MonoBehaviour
{
    ...
    public AK.Wwise.Switch roomSwitch1; 
    ...
    private void Update()
    {
        ...
        if (colorChangeController.RepairedObjects == colorChangeController.RepairableObjectsAmount)
        {
            roomSwitch1.SetValue(gameObject); // Setzt den Switch
            //ambienceEvent.Post(gameObject);  // Spielt den Sound ab
            trigger = true;
        }
    }
